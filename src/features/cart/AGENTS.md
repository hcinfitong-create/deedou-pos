...
Allowed dependencies: `src/shared/*`; receive product lookup and order status HTML from callers.
...
Tests: prioritize add/decrement/remove, subtotal, and submit validation.
